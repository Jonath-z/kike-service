...
const Footer = () => {
    return (
        <div className='grid grid-cols-3 justify-center items-center gap-10 px-44 py-10 mt-52 bg-black text-white font-OpenSans' id='footer'>
            <div className='flex flex-col justify-center items-center'>
                <p className='py-5 text-3xl'>About us</p>
                <p className='text-center'>
                    We are a company spacialized on woman's shoes<br/>
                    selling, we are based in Goma (DRC).<br/>
                    we sell best product and <br/> we provide a good service
                    to our clients.<br/>
            ...
            <div className='flex flex-col justify-center items-center'>
                ...
                <p className='px-10 cursor-pointer py-2'>Home</p>
                <p className='px-10 cursor-pointern py-2'>Shop</p>
